...
@patch('requests.get')
def test_external_api_collect_success(mock_get):
...
@patch('requests.get')
def test_external_api_collect_failure(mock_get):
...
@patch('requests.post')
def test_external_api_add_success(mock_post):
...
@patch('requests.post')
def test_external_api_add_failure(mock_post):
