...
class TestMessageService(unittest.TestCase):
    ...
    @patch('src.message_repository.message_repository.MessageRepository.save')
    def test_message_service_process_messages_success(self, mock_save, mock_collect, mock_get_cities):
    ...
    @patch('src.message_repository.message_repository.MessageRepository.find_all')
    @patch('src.message_repository.message_repository.MessageRepository.delete')
    def test_message_service_remove_old_messages(self, mock_delete, mock_find_all):
